#program for store teacher details and student attendance  using inheritance 
class employee:
...
for i in range(0,m):
	nme=input("Enter the name of the teacher:")
	c=input("Enter the code of the teacher :")
